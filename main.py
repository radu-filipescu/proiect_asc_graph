...
f = urllib.request.urlopen("https://www.top500.org")
mybytes = f.read()
...
main_url = "https://www.top500.org"
add_url = "lists/top500"
...
for year in range( 1993, 2021 ):
    ...
    for month in [ "06", "11" ]:
        ...
        if year > 2004: search_string = "<th>Rpeak (TFlop/s)</th>"
        else: search_string = "<th>Rpeak (GFlop/s)</th>"
...
progress /= 28
print( "Progresul mediu realizat pe an este:" , progress, "TFlops/s/year" )
